 ...
 *
 * @param UP Button
 * @desc This is the command name for the UP button.
 * @default UP
 *
 * @param UP Help
 * @desc This is the help description for the UP button.
 * @default UP
 * 
 * @param Right Button
 * @desc This is the command name for the Right button.
 * @default Right
 *
 * @param Right Help
 * @desc This is the help description for the Right button.
 * @default Right
 * 
 * @param Left Button
 * @desc This is the command name for the Left button.
 * @default Left
 *
 * @param Left Help
 * @desc This is the help description for the Left button.
 * @default Left
 * 
 * @param Down Button
 * @desc This is the command name for the Down button.
 * @default Down
 *
 * @param Down Help
 * @desc This is the help description for the Down button.
 * @default Down
 * 
 * @param Space Button
 * @desc This is the command name for the Space button.
 * @default Space
 *
 * @param Space Help
 * @desc This is the help description for the Space button.
 * @default Space
 * 
...
Yanfly.Param.GamepadConfigUPTx = String(Yanfly.Parameters['UP Button']);
Yanfly.Param.GamepadConfigUPHelp = String(Yanfly.Parameters['UP Help']);
Yanfly.Param.GamepadConfigRightTx = String(Yanfly.Parameters['Right Button']);
Yanfly.Param.GamepadConfigRightHelp = String(Yanfly.Parameters['Right Help']);
Yanfly.Param.GamepadConfigLeftTx = String(Yanfly.Parameters['Left Button']);
Yanfly.Param.GamepadConfigLeftHelp = String(Yanfly.Parameters['Left Help']);
Yanfly.Param.GamepadConfigDownTx = String(Yanfly.Parameters['Down Button']);
Yanfly.Param.GamepadConfigDownHelp = String(Yanfly.Parameters['Down Help']);
Yanfly.Param.GamepadConfigSpaceTx = String(Yanfly.Parameters['Space Button']);
...
Input.getGamepadButton = function(type) {
	for (var i = 0; i < 16; ++i) {
		if (Input.TetrisgamepadInput[i] === type) return i;
	}
	return null;
};
...
ConfigManager.TetrisgamepadInput = {
	0: 'ok',
	1: 'cancel',
	2: 'shift',
	3: 'space',
...
ConfigManager.makeData = function() {
  var config = Yanfly.GamepadConfig.ConfigManager_makeData.call(this);
	config.TetrisgamepadInput = this.TetrisgamepadInput;
	return config;
};
...
ConfigManager.applyData = function(config) {
  Yanfly.GamepadConfig.ConfigManager_applyData.call(this, config);
	this.TetrisgamepadInput = this.readGamepadConfig(config, 'TetrisgamepadInput');
...
Window_GamepadConfig.prototype.getButtonTypeText = function (index) {
	if (index === 0) return Yanfly.Param.GamepadConfigUPTx;
	if (index === 1) return Yanfly.Param.GamepadConfigDownTx;
	if (index === 2) return Yanfly.Param.GamepadConfigLeftTx;
	if (index === 3) return Yanfly.Param.GamepadConfigRightTx;
	if (index === 4) return Yanfly.Param.GamepadConfigSpaceTx;
	if (index === 5) return Yanfly.Param.GamepadConfigControlTx;
	if (index === 6) return Yanfly.Param.GamepadConfigOkTx;
	if (index === 7) return Yanfly.Param.GamepadConfigCancelTx;
	if (index === 8) return Yanfly.Param.GamepadConfigShiftTx;
...
Window_GamepadConfig.prototype.getButtonKey = function(index) {
	...
	if (index === 4) return 'space';
	if (index === 5) return 'control';
	if (index === 6) return 'ok';
	if (index === 7) return 'cancel';
	if (index === 8) return 'shift';
...
Window_GamepadConfig.prototype.updateHelp = function() {
	...
	switch (this.index()) {
		case 0:
			this._helpWindow.setText(Yanfly.Param.GamepadConfigUPHelp);
			break;
		case 1:
			this._helpWindow.setText(Yanfly.Param.GamepadConfigDownHelp);
			break;
		case 2:
			this._helpWindow.setText(Yanfly.Param.GamepadConfigLeftHelp);
			break;
		case 3:
			this._helpWindow.setText(Yanfly.Param.GamepadConfigRightHelp);
			break;
		case 4:
			this._helpWindow.setText(Yanfly.Param.GamepadConfigSpaceHelp);
			break;
		case 5:
...
Scene_GamepadConfig.prototype.applyButtonConfig = function(buttonId) {
	...
	ConfigManager.TetrisgamepadInput[buttonId] = newConfig;
	ConfigManager.TetrisgamepadInput[formerButton] = formerConfig;
	ConfigManager.applyGamepadConfig();
